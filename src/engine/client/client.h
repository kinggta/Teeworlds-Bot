...
class CClient : public IClient, public CDemoPlayer::IListner
{
	...
	class CNetClient m_InfoRequestClient;
...
public:
	...
	//queue functions
	virtual bool GetQueueActive() { return m_QueueActive; }
	virtual NETADDR GetQueueAddress() { return m_QueueAddress; }
	virtual int64 GetQueueTime() { return m_QueueConnectTime; }
	...
	const char *XGetName() { return m_LoginInfo.m_Name; }
	const char *XGetNews() { return m_XNews; }
	const char *XGetVersion() { return m_XVersion; }
	int XGetAuth() { return m_XAuth; }
	void XSendRequest(int Type, CLoginInfo *pInfo = 0);
	void XFetchInfo(char *pData);
