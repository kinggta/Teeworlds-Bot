...
void *CNetObjHandler::SecureUnpackMsg(int Type, CUnpacker *pUnpacker)
{
	...
	case NETMSGTYPE_CL_IS64PLAYER:
	{
		CNetMsg_Cl_Is64Player *pMsg = (CNetMsg_Cl_Is64Player *)m_aMsgData;
		(void)pMsg;
	} break;
	...
	{
		CNetMsg_Sv_TeamsState *pMsg = (CNetMsg_Sv_TeamsState *)m_aMsgData;
		(void)pMsg;
	} break;
