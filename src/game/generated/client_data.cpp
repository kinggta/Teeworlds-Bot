...
static CDataImage x14[] = {
	...
	/* x14[13] */ {  "x_menu_buttons",  "xclient/menu_buttons.png",  -1, },
};
...
static CDataSprite x44[] = {
	...
	/* x44[107] */ {  "x_mainbutton_editor_hot",  &x28[9],  0,  0,  4,  4, },
	/* x44[108] */ {  "x_mainbutton_editor_active",  &x28[9],  4,  0,  4,  4, },
	/* x44[109] */ {  "x_mainbutton_play_hot",  &x28[9],  0,  4,  4,  4, },
	/* x44[110] */ {  "x_mainbutton_play_active",  &x28[9],  4,  4,  4,  4, },
	/* x44[111] */ {  "x_mainbutton_demo_hot",  &x28[9],  0,  8,  4,  4, },
	/* x44[112] */ {  "x_mainbutton_demo_active",  &x28[9],  4,  8,  4,  4, },
	/* x44[113] */ {  "x_mainbutton_settings_hot",  &x28[9],  0,  12,  4,  4, },
	/* x44[114] */ {  "x_mainbutton_settings_active",  &x28[9],  4,  12,  4,  4, },
	/* x44[115] */ {  "x_mainbutton_news_hot",  &x28[9],  0,  16,  4,  4, },
	/* x44[116] */ {  "x_mainbutton_news_active",  &x28[9],  4,  16,  4,  4, },
	/* x44[117] */ {  "x_mainbutton_quit_hot",  &x28[9],  0,  20,  4,  4, },
	/* x44[118] */ {  "x_mainbutton_quit_active",  &x28[9],  4,  20,  4,  4, },
	/* x44[119] */ {  "x_mainbutton_13x37_hot",  &x28[9],  0,  24,  4,  4, },
	/* x44[120] */ {  "x_mainbutton_13x37_active",  &x28[9],  4,  24,  4,  4, },
};
static CAnimKeyframe x4498[] = {
	/* x4498[0] */ {  0.000000,  0.000000,  -4.000000,  0.000000, },
};
static CAnimKeyframe x4505[] = {
	/* x4505[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe x4512[] = {
	/* x4512[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe *x4519 = 0;
static CAnimKeyframe *x4543 = 0;
static CAnimKeyframe x4550[] = {
	/* x4550[0] */ {  0.000000,  -7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4557[] = {
	/* x4557[0] */ {  0.000000,  7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe *x4564 = 0;
static CAnimKeyframe *x4583 = 0;
static CAnimKeyframe x4590[] = {
	/* x4590[0] */ {  0.000000,  -3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe x4597[] = {
	/* x4597[0] */ {  0.000000,  3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4604 = 0;
static CAnimKeyframe x4623[] = {
	/* x4623[0] */ {  0.000000,  0.000000,  0.000000,  0.000000, },
	/* x4623[1] */ {  0.200000,  0.000000,  -1.000000,  0.000000, },
	/* x4623[2] */ {  0.400000,  0.000000,  0.000000,  0.000000, },
	/* x4623[3] */ {  0.600000,  0.000000,  0.000000,  0.000000, },
	/* x4623[4] */ {  0.800000,  0.000000,  -1.000000,  0.000000, },
	/* x4623[5] */ {  1.000000,  0.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4630[] = {
	/* x4630[0] */ {  0.000000,  8.000000,  0.000000,  0.000000, },
	/* x4630[1] */ {  0.200000,  -8.000000,  0.000000,  0.000000, },
	/* x4630[2] */ {  0.400000,  -10.000000,  -4.000000,  0.200000, },
	/* x4630[3] */ {  0.600000,  -8.000000,  -8.000000,  0.300000, },
	/* x4630[4] */ {  0.800000,  4.000000,  -4.000000,  -0.200000, },
	/* x4630[5] */ {  1.000000,  8.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4637[] = {
	/* x4637[0] */ {  0.000000,  -10.000000,  -4.000000,  0.200000, },
	/* x4637[1] */ {  0.200000,  -8.000000,  -8.000000,  0.300000, },
	/* x4637[2] */ {  0.400000,  4.000000,  -4.000000,  -0.200000, },
	/* x4637[3] */ {  0.600000,  8.000000,  0.000000,  0.000000, },
	/* x4637[4] */ {  0.800000,  8.000000,  0.000000,  0.000000, },
	/* x4637[5] */ {  1.000000,  -10.000000,  -4.000000,  0.200000, },
};
static CAnimKeyframe *x4644 = 0;
static CAnimKeyframe *x4743 = 0;
static CAnimKeyframe *x4750 = 0;
static CAnimKeyframe *x4757 = 0;
static CAnimKeyframe x4764[] = {
	/* x4764[0] */ {  0.000000,  0.000000,  0.000000,  -0.100000, },
	/* x4764[1] */ {  0.300000,  0.000000,  0.000000,  0.250000, },
	/* x4764[2] */ {  0.400000,  0.000000,  0.000000,  0.300000, },
	/* x4764[3] */ {  0.500000,  0.000000,  0.000000,  0.250000, },
	/* x4764[4] */ {  1.000000,  0.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4798 = 0;
static CAnimKeyframe *x4805 = 0;
static CAnimKeyframe *x4812 = 0;
static CAnimKeyframe x4819[] = {
	/* x4819[0] */ {  0.000000,  0.000000,  0.000000,  -0.250000, },
	/* x4819[1] */ {  0.100000,  0.000000,  0.000000,  -0.050000, },
	/* x4819[2] */ {  0.150000,  0.000000,  0.000000,  0.350000, },
	/* x4819[3] */ {  0.420000,  0.000000,  0.000000,  0.400000, },
	/* x4819[4] */ {  0.500000,  0.000000,  0.000000,  0.350000, },
	/* x4819[5] */ {  1.000000,  0.000000,  0.000000,  -0.250000, },
};
static CAnimation x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4498, },  /* x75[0].back_foot */ {  1,x4505, },  /* x75[0].front_foot */ {  1,x4512, },  /* x75[0].attach */ {  0,x4519, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4543, },  /* x75[1].back_foot */ {  1,x4550, },  /* x75[1].front_foot */ {  1,x4557, },  /* x75[1].attach */ {  0,x4564, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4583, },  /* x75[2].back_foot */ {  1,x4590, },  /* x75[2].front_foot */ {  1,x4597, },  /* x75[2].attach */ {  0,x4604, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4623, },  /* x75[3].back_foot */ {  6,x4630, },  /* x75[3].front_foot */ {  6,x4637, },  /* x75[3].attach */ {  0,x4644, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4743, },  /* x75[4].back_foot */ {  0,x4750, },  /* x75[4].front_foot */ {  0,x4757, },  /* x75[4].attach */ {  5,x4764, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4798, },  /* x75[5].back_foot */ {  0,x4805, },  /* x75[5].front_foot */ {  0,x4812, },  /* x75[5].attach */ {  6,x4819, }, },
};
static CDataSprite* *x4976 = 0;
static CDataSprite* x5113[] = {
	&x44[29],
	&x44[30],
	&x44[31],
};
static CDataSprite* x5298[] = {
	&x44[35],
	&x44[36],
	&x44[37],
};
static CDataSprite* *x5483 = 0;
static CDataSprite* *x5620 = 0;
static CDataSprite* x5757[] = {
	&x44[52],
	&x44[53],
	&x44[54],
};
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4976,  96,  125,  10,  0,  3,  4.000000,  -20.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x5113,  64,  125,  10,  500,  1,  32.000000,  4.000000,  50.000000,  6.000000,  5.000000, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5298,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  70.000000,  6.000000,  5.000000, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5483,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[4] */ {  "rifle",  &x44[47],  &x44[48],  &x44[49],  0,x5620,  92,  800,  10,  0,  5,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5757,  96,  800,  10,  0,  9,  0.000000,  0.000000,  40.000000,  -4.000000,  5.000000, },
};
