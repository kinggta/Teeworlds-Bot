...
image_x_menu_buttons = Image("x_menu_buttons", "xclient/menu_buttons.png")
...
container.images.Add(image_x_menu_buttons)
...
container.spritesets.Add(set_x_menu_buttons)
...
container.sprites.Add(Sprite("x_mainbutton_play_hot", set_x_menu_buttons, 0,4,4,4))
container.sprites.Add(Sprite("x_mainbutton_play_active", set_x_menu_buttons, 4,4,4,4))
container.sprites.Add(Sprite("x_mainbutton_demo_hot", set_x_menu_buttons, 0,8,4,4))
container.sprites.Add(Sprite("x_mainbutton_demo_active", set_x_menu_buttons, 4,8,4,4))
container.sprites.Add(Sprite("x_mainbutton_settings_hot", set_x_menu_buttons, 0,12,4,4))
container.sprites.Add(Sprite("x_mainbutton_settings_active", set_x_menu_buttons, 4,12,4,4))
container.sprites.Add(Sprite("x_mainbutton_news_hot", set_x_menu_buttons, 0,16,4,4))
container.sprites.Add(Sprite("x_mainbutton_news_active", set_x_menu_buttons, 4,16,4,4))
container.sprites.Add(Sprite("x_mainbutton_quit_hot", set_x_menu_buttons, 0,20,4,4))
container.sprites.Add(Sprite("x_mainbutton_quit_active", set_x_menu_buttons, 4,20,4,4))
container.sprites.Add(Sprite("x_mainbutton_13x37_hot", set_x_menu_buttons, 0,24,4,4))
container.sprites.Add(Sprite("x_mainbutton_13x37_active", set_x_menu_buttons, 4,24,4,4))
